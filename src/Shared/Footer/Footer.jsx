            ...
            <div className='bg-[#0c4b65] py-14'>
                <footer className="footer p-10 text-white ">
                    <div>
                        ...
                        <div className='flex ml-24 gap-8 mt-5'>
                            ...
                            <a target='_blank' rel="noreferrer" href='https://www.youtube.com/channel/UCNVOKzrXUjvwTXLm9v__vRw'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="#efcf4f"><path fill="#efcf4f" d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"></path></svg></a>
                            <a target='_blank' rel="noreferrer" href='https://www.facebook.com/mishu.ft.1'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="#efcf4f"><path fill="#efcf4f" d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a>
                    ...
                    <div>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <p>Daffodil International University, <br />Daffodil Smart City (DSC),<br />Birulia, Savar, Dhaka-1216</p>
                        </div>
                        <div className='flex gap-2'>
                        ...
                        <div className='flex gap-2'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 16"><path fill="#efcf4f" fillRule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42a18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z" /></svg>
                            <p>+8801682618182</p>
                        </div>
                    </div>
                    <div >
                        {/* map view of location */}
                        <div className="mapouter"><div className="gmap_canvas"><iframe src="https://maps.google.com/maps?q=daffodil%20international%20university,%20birulia&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed" className='lg:w-[400px] h-[200px]' ></iframe><a href="https://blooketjoin.org"></a></div></div>
                    </div>
                </footer>
