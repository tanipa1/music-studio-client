...
const ManageClasses = () => {
    ...
    const handleApproveClass = async (id) => {
        try {
            await axios.patch(`https://music-studio-server.vercel.app/classes/${id}`, { action: 'approve' });
            refetch();
    ...
    const handleDenyClass = async (id) => {
        try {
            await axios.patch(`https://music-studio-server.vercel.app/classes/${id}`, { action: 'deny' });
            refetch();
            setDisabledButtons([...disabledButtons, id]);
        } catch (error) {
            console.log(error);
    ...
    const handleOpenModal = (id) => {
      ...
      const handleFeedbackSubmit = async () => {
        try {
          await axios.patch(`https://music-studio-server.vercel.app/classes/${currentItemId}`, {
            action: 'feedback',
            feedback: feedback
          });
          setShowModal(false);
